		...
		<view v-for="(item, index) in addressList" :key="index" class="order_address">
			<view class="address_box">
				...
				<view @click="onsetAddress(item)">
					<view class="center">
						<view class="moren" v-if="item.isdefult">
						...
						<view class="address_name">{{item.address}}{{item.detailAddress}}</view>
					</view>
				</view>
				<view class="caozuo">
					...
					<view class="del" @tap="delAddress(item,index)" :style="'color:' + colors">
